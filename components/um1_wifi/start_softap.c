...
{
	esp_netif_t *ap_netif = pvParameters;
    ...
    while (1) {
        ...
        const char *resp = "Hello from ESP32 WIFI AP Ethernet TCP server!\r\n";
                                    ...
                                    int32_t event_id, void* event_data)
{
    if (event_id == WIFI_EVENT_AP_STACONNECTED) {
    	...
    	xTaskCreate(wifi_tcp_server_task, "tcp_ap", 4096, ap_netif, tskIDLE_PRIORITY+5, NULL);
    }
}
